...
public enum Messages {
    ...
    PRODUCT_ALREADY_EXISTS_UPDATE("Product already exists. Please update the product quantity"),
    ...
    REVIEW_ALREADY_EXISTS("review already exist regarding the mentioned product"),
